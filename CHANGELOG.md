...
* [[FeedManager](docs/Managers/Feed.md)] Support [FeedCancel](https://developers.linio.com/reference/feedcancel) action
* [`FeedResponse`] Added `requestParameters` property
